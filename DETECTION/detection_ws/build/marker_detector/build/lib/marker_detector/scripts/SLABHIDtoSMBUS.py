...
if sys.platform == 'win32':
    ...
    _DLL_prev = ct.CDLL(os.path.join(_SCRIPT_DIR, "libslabhiddevice.so.1.0"), mode=ct.RTLD_GLOBAL)
    _DLL = ct.cdll.LoadLibrary(os.path.join(_SCRIPT_DIR, "libslabhidtosmbus.so.1.0"))
