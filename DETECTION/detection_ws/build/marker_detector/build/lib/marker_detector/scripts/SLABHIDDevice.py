...
if sys.platform == 'win32':
    g_DLL = ctypes.windll.LoadLibrary(os.path.join(_SCRIPT_DIR, "SLABHIDDevice.dll"))
elif sys.platform == 'darwin':
    g_DLL = ctypes.cdll.LoadLibrary(os.path.join(_SCRIPT_DIR, "libSLABHIDDevice.dylib"))
else:  # Linux
    g_DLL = ctypes.cdll.LoadLibrary(os.path.join(_SCRIPT_DIR, "libslabhiddevice.so.1.0"))
